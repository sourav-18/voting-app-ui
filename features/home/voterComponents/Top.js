...
const Top = () => {
  ...
  return (
    <View style={styles.containner}>
      <Pressable style={styles.card} onPress={()=>navigation.navigate("VoterUpcomeingElection")}>
        <Octicons style={styles.icon}name="broadcast" size={24} color="white" />
        <Text style={styles.text}>Upcoming Voting</Text>
      </Pressable>
      <Pressable style={styles.card} onPress={()=>navigation.navigate("TodayVote")}>
      <Octicons style={styles.icon} name="checklist" size={24} color="white" />
        <Text style={styles.text}>Today Vote</Text>
      </Pressable>
    </View>
  );
};
