  ...
  return (
    <View style={styles.container}>
      ...
      <Ionicons style={styles.iconOne} name="hand-right-outline" size={24} color="white" />
       ...
       <Pressable onPress={()=>navigator.navigate("VoterRegisterElection")}><Octicons style={styles.iconTow} name="chevron-right" size={30} color="white" /></Pressable>
      </View>
      <View style={styles.card}>
      <MaterialIcons style={styles.iconOne} name="align-horizontal-right" size={24} color="white" />
        <Text style={styles.text}>Unattempted Election </Text>
       <Pressable  onPress={()=>navigator.navigate("UnAttemptedVoter")}><Octicons style={styles.iconTow} name="chevron-right" size={30} color="white" /></Pressable>
      </View>
      <View style={styles.card}>
      <Ionicons style={styles.iconOne} name="hand-right-outline" size={24} color="white" />
